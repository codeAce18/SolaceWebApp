...
const FileUploadDoc: React.FC<FileUploadProps> = ({ onDrop }) => {
  ...
  return (
    ...
    >
      ...
      <Typography className='lg:text-[17px] text-[15px]'>
        <span className="text-Fozanova-gold  lg:text-[17px] text-[15px]">Click to upload your portrait photo</span> or drag and drop
      </Typography>
