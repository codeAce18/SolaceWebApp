...
const FileUploadDocto: React.FC<FileUploadProps> = ({ onDrop }) => {
  ...
  return (
    ...
    >
      ...
      <Typography className='lg:text-[17px] text-[15px]'>
        <span className="text-Fozanova-gold  lg:text-[17px] text-[15px]">Click to upload proof of residential address i.e NEPA Bill </span> or drag and drop
      </Typography>
...
export default FileUploadDocto;
