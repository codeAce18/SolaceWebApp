...
const FileUploadPharma: React.FC<FileUploadProps> = ({ onDrop }) => {
  ...
  return (
    ...
    >
      ...
      <Typography>
        <span className="text-Fozanova-gold font-semibold lg:text-[17px] text-[15px]">Click to upload proof of pharmacy address i.e NEPA Bill </span> or drag and drop
      </Typography>
...
export default FileUploadPharma;
