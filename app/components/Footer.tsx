...
export function Footer() {
  ...
  return (
    <div className="pt-20">
      <div ref={footerRef} className={`bg-[#121933] py-[50px] transition-opacity duration-1000 ${footerInView ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className="max-w-[1280px] mx-auto lg:flex items-center gap-56 justify-center border-b-[1px] border-b-[#FFFFFF80]">
          <div>
            <h6 className={`pt-[30px] text-center lg:text-[20px] text-[17px] lg:leading-[20px] leading-[17px] font-semibold text-white transition-transform duration-1000 ${footerInView ? 'transform translate-x-0' : 'transform translate-x-10'}`}>Coverage</h6>
            <p className={`pb-[30px] mx-auto text-white pt-[10px] lg:text-[17px] text-[15px] lg:leading-[26px] tracking-[-0.4%] max-w-[219px] text-center transition-transform duration-1000 ${footerInView ? 'transform translate-x-0' : 'transform translate-x-10'}`}>
              36 States of the Federation Including the FCT, Abuja.
            </p>
          </div>
          <div>
            <h6 className={`text-center lg:text-[20px] text-[17px] leading-[17px] lg:leading-[20px] font-semibold text-white pt-[30px] transition-transform duration-1000 ${footerInView ? 'transform translate-x-0' : 'transform translate-x-10'}`}>
              Address
            </h6>
          ...
          <div>
            <h6 className={`text-center lg:text-[20px] text-[17px] leading-[20px] font-semibold text-white pt-[30px] transition-transform duration-1000 ${footerInView ? 'transform translate-x-0' : 'transform translate-x-10'}`}>
              Contact
            </h6>
