...
export function PartnerWithUs() {
    ...
    return (
        <div className="pt-16 p-[20px]">
            <div
                ref={sectionRef}
                className={`flex flex-col items-center justify-center transition-opacity duration-1000 ${sectionInView ? 'opacity-100' : 'opacity-0'}`}
            >
                <Image width={175} height={40} src={PartnerWithUsSvg} alt="partnerWithUsSvg" />

                <h1 className="text-center font-normal lg:text-[48px] text-[35px] lg:leading-[58px] leading-[40px] tracking-[-1px] text-Fozanova-Black lg:max-w-[900px] max-w-[300px]">
                    Pharmacies, Hospitals and Laboratories in Nigeria, Partner with Us
                </h1>
            </div>
            ...
            <div className="pt-5">
                <div
                    ref={sectionRef}
                    className={`rounded-[32px] bg-Fazanova-white border-[1px] border-[#EFF0F6] max-w-[1058px] py-[40px] px-[32px] mx-auto lg:flex items-center justify-center gap-10 transition-transform duration-1000 ${sectionInView ? 'translate-y-0' : 'translate-y-10'}`}
                >
                    ...
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <Link href="/partnerwithus" className="lg:pt-[17px] pt-[40px]">
