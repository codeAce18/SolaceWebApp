  ...
  return (
    ...
    <>
      ...
      <div className="lg:pt-32 pt-16">
        ...
        <h1 className="font-normal lg:text-[48px] text-[35px] tracking-[-1px] text-center lg:max-w-[935px] max-w-[600px] mx-auto text-Fozanova-Black lg:leading-[58px] leading-[50px] lg:h-[174px]">
          ...
          <div className="pt-16 px-[20px] lg:px-0  max-w-[1058px] mx-auto">
        ...
        <div className="pt-20 px-[20px] lg:px-0">
          <div className="bg-Fazanova-white rounded-[32px] border-[1px] border-[#EFF0F6] max-w-[1157px] mx-auto py-[36px] px-[28px] lg:flex items-center justify-center gap-10">
            ...
            <div className="max-w-[553px] pt-[40px] lg:pt-0 mx-auto">
          ...
          <div className="p-10">
                <div className="flex justify-center items-center">
                    <div className="bg-Fazanova-white rounded-[16px] border-[1px] border-[#EFF0F6] py-[47px] px-[32px] max-w-[1055px] grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-20 lg:gap-y-36 gap-y-28">
                        ...
                        <div className="lg:border-r-[1px] border-r-[#EFF0F6]  lg:pr-8 flex flex-col justify-center items-center">
                            <Image className="mx-auto" width={39.65} height={36} src={CustomercentricSvg} alt="customerCentricSvg" />
                            ...
                            <p className="pt-5 text-center max-w-[231px] font-normal text-[17px] leading-[26px] tracking-[-0.4%] text-p-grey"> Putting our customers is at the heart of everything we do, delivering exceptional experiences and exceeding their expectations.</p>
                        </div>
                        <div className="flex flex-col justify-center items-center">
                            <Image className="mx-auto" width={37.85} height={36} src={SustainabilitySvg} alt="sustainanbilitySvg" />
                        ...
                        <div className="lg:border-l-[1px] border-l-[#EFF0F6]  lg:pl-8 flex flex-col justify-center items-center">
                            <Image className="mx-auto" width={34.74} height={36} src={ExcellenceSvg} alt="ExcellenceSvg" />
