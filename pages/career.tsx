      ...
      <>
        ...
        <div className="lg:pt-32 pt-16">
          <div className="flex flex-col items-center justify-center">
            ...
            className="text-center font-normal lg:text-[48px] text-[40px] lg:leading-[58px] leading-[50px] text-Fozanova-Black max-w-[935px] tracking-[-1px]">Join us, let&apos;s give the elderly solace</motion.h1>
            ...
            animate="visible"
            transition={{ duration: 0.6 }}
            className="lg:pt-[20px] pt-[16px] text-[15px] lg:text-[17px] tracking-[-0.4%] leading-[22px] max-w-[930px] text-center text-p-grey lg:leading-[26px]">Looking for an opportunity to showcase your skills and bring your creativity to live? Join our global team of talented workforce today and be part of the team revolutionizing the elderly care industry in Africa. </motion.p>
              ...
              <div className="lg:flex lg:flex-row flex flex-col-reverse items-center justify-center gap-10">
                ...
                <div>
                  ...
                  <motion.h1 
                   ...
                   animate="visible"
                   transition={{ duration: 0.6 }}
                  className="text-center lg:text-left font-normal text-Fozanova-Black text-[40px] lg:text-[48px] lg:leading-[58px] leading-[50px] tracking-[-0.4%] max-w-[422px]">Perks That Go Beyond Borders</motion.h1>
                  ...
                  <motion.p 
                   ...
                   animate="visible"
                   transition={{ duration: 0.6 }}
                  className="pt-[30px] text-center lg:text-left text-[15px] text-p-grey lg:text-[17px] leading-[22px] lg:leading-[26px] max-w-[417px]">Enjoy flexible work environments, cultural diversity, personal development opportunities, travel adventures, wellness benefits and competitive compensation.</motion.p>
                </div>
              </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 max-w-[1058px] gap-6 pt-10 mx-auto">
              <div className="border-[1px] border-[#EFF0F6] lg:rounded-[8px] lg:max-w-[570px] mx-auto lg:mx-0 py-[22px] px-[20px]  bg-Fazanova-white">
                <motion.h1 
                 ...
                 animate="visible"
                 transition={{ duration: 0.6 }}
                className="border-b-[1px] border-b-[#D9D9D9] pb-[10px] lg:text-[20px] text-[17px] font-normal leading-[27.42px] tracking-[-0.96px] text-Fozanova-Black">Flexible Work Environment</motion.h1>
                ...
                <motion.p
                 ...
                 animate="visible"
                 transition={{ duration: 0.6 }}
                className="text-[15px] pt-[10px] lg:text-[17px] text-p-grey lg:leading-[26px] leading-[22px] tracking-[-0.4%] max-w-[492px] ">Enjoy the freedom to work from anywhere in the world, whether it&apos;s the comfort of your home office or the excitement of a new city. Embrace a work-life balance that suits your needs.</motion.p>
              </div>
              ...
              <div className="border-[1px] border-[#EFF0F6] lg:rounded-[8px] max-w-[570px]  mx-auto lg:mx-0 py-[22px] px-[20px]  bg-Fazanova-white">
                <motion.h1
                 ...
                 animate="visible"
                 transition={{ duration: 0.6 }} 
                className="lg:text-[20px] border-b-[1px] border-b-[#D9D9D9] pb-[10px] text-[17px] font-normal leading-[27.42px] tracking-[-0.96px] text-Fozanova-Black">Cultural Diversity</motion.h1>
                ...
                <motion.p 
                 ...
                 animate="visible"
                 transition={{ duration: 0.6 }}
                className="text-[15px] pt-[10px] lg:text-[17px] text-p-grey lg:leading-[26px] leading-[22px] tracking-[-0.4%] max-w-[492px] ">Experience the richness of working with a global team. Collaborate with professionals from different backgrounds, cultures, and perspectives, fostering creativity, innovation, and personal growth.</motion.p>
              </div>
              ...
              <div className="border-[1px] border-[#EFF0F6] rounded-[8px] max-w-[570px]  mx-auto lg:mx-0 py-[22px] px-[20px]  bg-Fazanova-white">
                <motion.h1 
                 ...
                 animate="visible"
                 transition={{ duration: 0.6 }}
                className="lg:text-[20px] border-b-[1px] border-b-[#D9D9D9] pb-[10px] text-[17px] font-normal leading-[27.42px] tracking-[-0.96px] text-Fozanova-Black">Personal Development</motion.h1>
              ...
              <div className="border-[1px] border-[#EFF0F6] lg:rounded-[8px] max-w-[570px]  mx-auto lg:mx-0 py-[22px] px-[20px]  bg-Fazanova-white">
                <motion.h1 
                 ...
                 animate="visible"
                 transition={{ duration: 0.6 }}
                className="lg:text-[20px] border-b-[1px] border-b-[#D9D9D9] pb-[10px] text-[17px] font-normal leading-[27.42px] tracking-[-0.96px] text-Fozanova-Black">Travel Opportunities</motion.h1>
                ...
                <motion.p 
                 ...
                 animate="visible"
                 transition={{ duration: 0.6 }}
                className="text-[15px] lg:text-[17px] pt-[10px] text-p-grey lg:leading-[26px] leading-[22px] tracking-[-0.4%] max-w-[492px] ">Embark on exciting journeys and visit different locations as part of your job. Engage in on-site collaborations, attend conferences, or simply enjoy the experience of working in diverse environments.</motion.p>
              </div>
              ...
              <div className="border-[1px] border-[#EFF0F6] lg:rounded-[8px] max-w-[570px]  mx-auto lg:mx-0 py-[22px] px-[20px]  bg-Fazanova-white">
                <motion.h1 
                 ...
                 animate="visible"
                 transition={{ duration: 0.6 }}
                className="lg:text-[20px] border-b-[1px] border-b-[#D9D9D9] pb-[10px] text-[17px] font-normal leading-[27.42px] tracking-[-0.96px] text-Fozanova-Black">Wellness Benefits</motion.h1>
                ...
                <motion.p 
                 ...
                 animate="visible"
                 transition={{ duration: 0.6 }}
                className="text-[15px] lg:text-[17px] pt-[10px] text-p-grey lg:leading-[26px] leading-[22px] tracking-[-0.4%] max-w-[492px] ">Enjoy robust HMO cover from the day of your confirmation. We ensure our staffs health are covered by providing them with health insurance plan that ensures that we have a healthy workforce, worldwide. </motion.p>
              </div>
              ...
              <div className="border-[1px] border-[#EFF0F6] lg:rounded-[8px] max-w-[570px]  mx-auto lg:mx-0 py-[22px] px-[20px]  bg-Fazanova-white">
                <motion.h1 
                 ...
                 animate="visible"
                 transition={{ duration: 0.6 }}
                className="lg:text-[20px] border-b-[1px] border-b-[#D9D9D9] pb-[10px] text-[17px] font-normal leading-[27.42px] tracking-[-0.96px] text-Fozanova-Black">Competitive Compensation</motion.h1>
                ...
                <motion.p 
                 ...
                 animate="visible"
                 transition={{ duration: 0.6 }}
                className="text-[15px] lg:text-[17px] pt-[10px] text-p-grey lg:leading-[26px] leading-[22px] tracking-[-0.4%] max-w-[492px] ">Benefit from a competitive compensation package that recognizes your skills and contributions. Enjoy the perks of a global company that values your expertise and rewards you accordingly.</motion.p>
              </div>
            </div>
          </div>
