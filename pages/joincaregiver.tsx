            ...
            <div className="lg:pt-32 pt-16 p-[20px] lg:p-0">
                ...
                <div>
                    <div>
                        ...
                        <p className="pt-[20px] text-center mx-auto lg:max-w-[930px] lg:text-[17px] text-[15px] lg:leading-[26px] leading-[22px] tracking-[-0.4%] text-p-grey">We offer comprehensive in-home care for the elderly across Africa through our certified network of caregivers. 
                        We recruit only qualified, vetted professionals and compensate them gene
                        </p>
                        
                        <p className="text-Fozanova-Black text-center mx-auto pt-[10px] lg:pt-0 max-w-[300px] lg:max-w-[930px] lg:text-[17px] text-[15px] lg:leading-[26px] leading-[22px] tracking-[-0.4%]">Join us in transforming the elderly care sector in Africa.</p>
                    </div>

                    <div className="pt-20">
                        <div className="bg-Fazanova-white rounded-[16px] border-[1px] border-[#EFF0F6] py-[47px] px-[32px] max-w-[714px] grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-20 lg:gap-y-36 gap-y-28 mx-auto">
