...
const PartnershipSuccess = () => {
    return (
        <div className="relative flex flex-col justify-center items-center min-h-[100vh]">
            ...
            <p className="lg:text-[17px] pt-[10px] text-[15px] lg:leading-[26px] leading-[22px] tracking-[-0.4%] text-[#7A7D9C] lg:max-w-[534px] max-w-[250px] text-center">Your partnership application form was submitted successfully.<br /> Check your email for a message from our account officer<br/> about advancing our relationship.</p>
